...
The results from the multi-level model were largley insignificant, but when estimating a pooled model, i.e. all farmers taken as a single sample, we see some interesting effects.  The effect of participating in bethma during the drought did not have any significant effect on yield.  Owning an agrowell had a strong positive effect on yield.  Owning land surprisingly had a negative effect on yield, as did socio-economic status.  This may reflect the fact that these farmers opted out of cultivation during this drought (?).  We also see a small but significant effect of the total hectares owned on rice yield per acre (i.e. farmers with more fields tend to generate higher per acre yields).  There's a unit mis-match here (acres in independent, hectares in dependent); we'd need to fix this if we decide to include these results.
